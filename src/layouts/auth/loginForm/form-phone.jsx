  ...
  return (
    <div className="form-box">
      ...
      <div className="form-container-box" ref={containerRef}>
        {/* 登录 */}
        <div
          className={`form-container sign-in-phone ${
            loginStatus ? 'phone-hide' : 'phone-show'
          }`}
          style={{
        ...
        {/* 注册 */}
        <div
          className={`form-container sign-up-phone ${
            loginStatus ? 'phone-show' : 'phone-hide'
          }`}
          style={{
